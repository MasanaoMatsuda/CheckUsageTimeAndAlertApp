...
public class CountTimeService extends Service {
    ...
    private long mPreferenceTime = 1000 * 6;
    ...
    // 間隔が短すぎるループを停止させる処理に使1う定数(10秒に設定）
    ...
    public void onCreate() {
        ...
        // ToDo:確認後消去OK
        Log.d(TAG, "Check mPreferenceTime :" + mPreferenceTime +
                "\nmThreadSleepTime :" + mThreadSleepTime);
    }
    ...
    private void extractUsage() {
        ...
        while (usageEvents.hasNextEvent()) {
            ...
            if (packageName.equals(mLauncherPackageName) | packageName.equals(SYSTEM_UI)) {
                Log.d(TAG, "Skipped.[mLauncherPackageName] or [SYSTEM_UI]");
                continue;
            }
